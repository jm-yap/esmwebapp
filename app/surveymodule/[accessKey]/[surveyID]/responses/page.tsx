    ...
    return (
      <div className="p-6 max-w-5xl mx-auto bg-white rounded-xl shadow-md flex flex-col items-center space-x-4">
        ...
        <Link
          ...
          className="mt-4 inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-purple-500 rounded shadow ripple hover:shadow-lg hover:bg-purple-600 focus:outline-none mb-4"
        >
